...
alter table customer disable constraint C_CCN_FK;
...
values('c'||to_char(cust_id_seq.nextval,'fm0999'),'David','jamir Lane','Mangalore',580254,'BN','david@oracle.com',8457692461,6547981236453287);
insert into customer(customer_id,customer_name,street_address,city,zip,state,email_address,phone_number,credit_card_number)
values('c'||to_char(cust_id_seq.nextval,'fm0999'),'Ramanuj','jamir Lane','Mangalore',580254,'BN','ramanuj@oracle.com',7894563271,7895314521795463);
insert into customer(customer_id,customer_name,street_address,city,zip,state,email_address,phone_number,credit_card_number)
values('c'||to_char(cust_id_seq.nextval,'fm0999'),'venkatesh','ho chin minh','Jp nagar',580254,'BN','venky@oracle.com',5412975236,6847925814236541);
insert into customer(customer_id,customer_name,street_address,city,zip,state,email_address,phone_number,credit_card_number)
values('c'||to_char(cust_id_seq.nextval,'fm0999'),'subramanian','paratha gali','whitefield',580254,'BN','subram@oracle.com',4536578925,4236152819743652);
insert into customer(customer_id,customer_name,street_address,city,zip,state,email_address,phone_number,credit_card_number)
values('c'||to_char(cust_id_seq.nextval,'fm0999'),'vikram','khaogali','whitefield',580254,'BN','vikram@oracle.com',1453698258,2459736814563871);
SELECT * FROM CUSTOMER;


--CREDIT CARD DETAILS
insert into credit_card_details(credit_card_number,credit_card_type,customer_id,expiry_date)
values((select credit_card_number from customer where customer_name='David'),'Maestro',(select customer_id from customer where customer_name='David'),'10-12-2025');
insert into credit_card_details(credit_card_number,credit_card_type,customer_id,expiry_date)
values((select credit_card_number from customer where customer_name='Ramanuj'),'Maestro',(select customer_id from customer where customer_name='Ramanuj'),'01-11-2026');
insert into credit_card_details(credit_card_number,credit_card_type,customer_id,expiry_date)
values((select credit_card_number from customer where customer_name='venkatesh'),'Maestro',(select customer_id from customer where customer_name='venkatesh'),'12-12-2025');
insert into credit_card_details(credit_card_number,credit_card_type,customer_id,expiry_date)
values((select credit_card_number from customer where customer_name='subramanian'),'Maestro',(select customer_id from customer where customer_name='subramanian'),'20-12-2021');
insert into credit_card_details(credit_card_number,credit_card_type,customer_id,expiry_date)
values((select credit_card_number from customer where customer_name='vikram'),'Maestro',(select customer_id from customer where customer_name='vikram'),'31-12-2030');
...
alter table customer enable constraint C_CCN_FK;
