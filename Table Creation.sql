...
Credit_Card_Number integer check(Credit_card_number <=9999999999999999),
...
--ADDING A FOREIGN KEY TO CUSTOMER TABLE REFERENCING TO CREDIT_CARD_DETAILS_TABLE
alter table customer add constraint c_ccn_fk foreign key(credit_card_number) references credit_card_details(credit_card_number) on delete cascade;
